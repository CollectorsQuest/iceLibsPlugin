...
class PhpClosure
{
  ...
  /**
   * Gets the compilation mode from the URL, set the mode param to 'w', 's' or 'a'.
   *
   * @return \PhpClosure
   */
  ...
  private function _makeRequest()
  {
    ...
    if ($fp = fsockopen("closure-compiler.appspot.com", 80, null, null, 5))
    {
  ...
  {
    return $this->_parseXmlHelper(new SimpleXMLElement($data));
  }
